...
class TrainingCompanyTest {
    ...
    void init() {
        List<Course> courses = Arrays.asList(
                ...
                new Course("Biztonsági õr", Level.ADVANCED, 145000),
                new Course("Bér- és TB ügyintézõ", Level.BEGINNER, 86000)
        );
    ...
    void testGetPriceOfCourseWithGivenNameAndLevel() {
        assertEquals(145000, company.getPriceOfCourseWithGivenNameAndLevel("Biztonsági õr", Level.ADVANCED));
    }

    @Test
    void testGetPriceOfCourseWithGivenNameAndLevelNoSuchCourse() {
        Exception ex = assertThrows(IllegalArgumentException.class,
                () -> company.getPriceOfCourseWithGivenNameAndLevel("Titkárnõ", Level.BEGINNER));
        assertEquals("No such course.", ex.getMessage());
    }

    @Test
    void testGetNameOfCourseWithGivenLevel() {
        assertEquals("Bér- és TB ügyintézõ", company.getNameOfCourseWithGivenLevel(Level.BEGINNER));
    }
